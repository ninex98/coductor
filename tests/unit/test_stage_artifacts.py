...
def test_success_stage_artifacts_define_fixed_yaml_contract() -> None:
    ...
    assert "03_verification_plan.yaml" in paths
    ...
    assert "07_goal_satisfaction.yaml" in paths
...
def test_tool_stage_artifacts_define_fixed_yaml_contract() -> None:
    paths = artifact_paths(TOOL_STAGE_ARTIFACTS)
